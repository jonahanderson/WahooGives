...
if ( isset( $_SESSION['user_id'] ) ) {
   ...
   $mesage = "Nothing is working";
        ...
        $mail->AddAddress("WahooGives.2020@gmail.com");
        if(!$mail->Send()) 
          {
                ...
                <div>
                    ...
                    <div class="icon-contacts pb-3">
                        ...
                        <p class="mbr-text align-left mbr-fonts-style display-7">
                            ...
                            Email: WahooGives.2020@gmail.com
                        </p>
                    </div>
                </div>
        ...
        <div class="footer-lower">
            ...
            <div class="media-container-row mbr-white">
                <div class="col-md-6 copyright">
                     <span class="navbar-caption-wrap"> <img class="center" src="assets/images/logo_size2.png" style="width:150px;height:50px;" alt="" title="">  </span>
                    <p class="mbr-text mbr-fonts-style display-7">
                        © Copyright 2019 <a href="https://webdesignvista.com">WahooGives</a> - All Rights Reserved
                    </p>
                </div>
                <!-- <div class="col-md-6">
